...
from . import alexnet as alexnet
from . import vggnet as vgg
from . import prevggnet as prevgg
from . import resnet as resnet
from . import preresnet as preresnet
from . import resnext as resnext
from . import wideresnet as wideresnet
from . import seresnet as seresnet
from . import cbamresnet as cbamresnet
from . import vit as vit
from . import pit as pit
from . import mixer as mixer
from . import alternet as alternet
from ..ops import meters as meters
...
def get_model(name, num_classes=10, stem=False, verbose=True, **block_kwargs):
    ...
    # ResNet
        ...
        model = resnet.dnn_101(
            num_classes=num_classes, stem=stem, name=name, **block_kwargs
        )
    elif name in ["resnet_mcdo_101"]:
        model = resnet.mcdo_101(
            num_classes=num_classes, stem=stem, name=name, **block_kwargs
        )
        ...
        model = resnet.dnn_152(
            num_classes=num_classes, stem=stem, name=name, **block_kwargs
        )
    elif name in ["resnet_mcdo_152"]:
        model = resnet.mcdo_152(
            num_classes=num_classes, stem=stem, name=name, **block_kwargs
        )
    ...
    # ResNeXt
        ...
        model = resnext.dnn_50(
            num_classes=num_classes, stem=stem, name=name, **block_kwargs
        )
    elif name in ["resnext_mcdo_50"]:
        model = resnext.mcdo_50(
            num_classes=num_classes, stem=stem, name=name, **block_kwargs
        )
...
def save_snapshot(
    model, dataset_name, uid, typ, optimizer=None, root="models_checkpoints"
):
